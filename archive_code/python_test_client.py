...
def test_common1():
    ...
    assert_fault_xmlrpc("get_security_context", 111, "FSGDFGDFGdfgfdg")
...
jjj="""
def test_users(org_id, users):
    try:
        rpc_users_list = server.list_users(server_sid, org_id)
        rpc_users = Users()
        rpc_users = rpc_users.from_list(rpc_users_list)
